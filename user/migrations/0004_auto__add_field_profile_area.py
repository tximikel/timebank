...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('user_profile', 'area',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='profiles', null=True, to=orm['serv.Area']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.area'
        db.delete_column('user_profile', 'area_id')
    ...
    models = {
        ...
        'user.profile': {
            ...
            'birth_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 11, 0, 0)'}),
